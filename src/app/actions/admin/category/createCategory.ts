...
export const createCategory = async ({ name, description, isActive }: { name: string; description: string; isActive: boolean }) => {
	'use server';
	...
	try {
		...
		return { success: true, message: 'Created category successfully' };
	} catch (error) {
